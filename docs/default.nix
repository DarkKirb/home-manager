...
let
  ...
  nmdSrc = fetchTarball {
    url =
      "https://gitlab.com/api/v4/projects/rycee%2Fnmd/repository/archive.tar.gz?sha=aedc2fcd4d2aeb287cdd53acc70f2aea01a45abf";
    sha256 = "0xld5xpl07p9fvb2apiiqfyjqigzpbzkwjl3mih080dl9226zms9";
  };
